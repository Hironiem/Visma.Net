...
namespace ONIT.VismaNetApi.Lib.Data
{
    public class CustomerCreditNoteData : BasePaginatedCrudDataClass<CustomerCreditNote>
    {
        ...
        {
            return await VismaNetApiHelper.DeleteCreditNote(invoiceNumber, Authorization);
        }
        ...
        public async Task<Stream> PrintCreditNote(CustomerCreditNote creditNote)
        {
            return await VismaNetApiHelper.CreditNotePrint(creditNote.GetIdentificator(), Authorization);
        }
